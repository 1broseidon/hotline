...
| Gemini generateContent | Inline image bytes share a 20 MB request budget with text and instructions. Files API is recommended for larger/reused inputs; Hotline uses inline input. | [Image understanding](https://ai.google.dev/gemini-api/docs/generate-content/image-understanding) |
