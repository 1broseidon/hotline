 ...
 */
about: string, } | { "kind": "linked", personaId: string, name: string, threadKey: string, 
/**
 ...
 */
export type LinkPauseStatus = "pending" | "resumed" | "unlinked";
 ...
 */
export type TeammateLink = { withPersonaId: string, 
/**
 ...
 * teammate.
 */
seat?: PeerSeat, } | { "kind": "delivery", id: string, ts: number, cause: DeliveryCause, text: string, receipt?: Receipt, } | { "kind": "link_paused", id: string, ts: number, withPersonaId: string, withName: string, exchanges: number, status: LinkPauseStatus, } | { "kind": "turn", id: string, ts: number, stopReason: string, usage?: TokenUsage, } | { "kind": "subagent", id: string, 
/**
