 ...
 * keep in step. The source of truth is assets/toad-mark.svg, and the app
 ...
 */
export function ToadMark({ className, label, width = 20 }: { className?: string; label?: string; width?: number }) {
	return (
		<svg
			className={className}
